/*
Seed_SrvCarRequest_Menu.sql
منو: سیستم عمومی/مشترک → پشتیبانی و خدمات → عملیات → درخواست خودرو
فقط این برگ؛ بدون حذف همسایه‌ها. UTF-8 BOM. Idempotent. الگوی Seed_SrvTicketHotelRequest_Menu.
sqlcmd -S <server> -d HavayarApp -C -b -I -f 65001 -i "Data\Scripts\Seed_SrvCarRequest_Menu.sql"
*/
SET NOCOUNT ON;
SET XACT_ABORT ON;
...
DECLARE @SeedUser NVARCHAR(150) = N'seed-srv-carrequest-menu';
DECLARE @Path NVARCHAR(200) = N'/panel/srv/carrequest/list';
...
DECLARE @LeafText NVARCHAR(200) = N'درخواست خودرو';

DECLARE @Leaf NVARCHAR(MAX) = N'{"text":"درخواست خودرو","icon":"ki-element-11 ki-outline","iconColor":"#5EEAD4","path":"/panel/srv/carrequest/list","a_attr":{"href":"/panel/srv/carrequest/list"},"data":{"iconColor":"#5EEAD4","path":"/panel/srv/carrequest/list"},"children":[]}';
DECLARE @OpsGroup NVARCHAR(MAX) = N'{"text":"عملیات","icon":"ki-element-11 ki-outline","iconColor":"#5EEAD4","path":"","a_attr":{"href":""},"data":{"iconColor":"#5EEAD4","path":""},"children":[{"text":"درخواست خودرو","icon":"ki-element-11 ki-outline","iconColor":"#5EEAD4","path":"/panel/srv/carrequest/list","a_attr":{"href":"/panel/srv/carrequest/list"},"data":{"iconColor":"#5EEAD4","path":"/panel/srv/carrequest/list"},"children":[]}]}';
...
BEGIN TRY
    ...
    ELSE IF CHARINDEX(N'"path":"' + @Path + N'"', @Content) > 0
        PRINT N'  برگ درخواست خودرو از قبل موجود است';
    ELSE
    BEGIN
            ...
            BEGIN
                ...
                BEGIN
                    SET @Content = JSON_MODIFY(@Content,
                        ...
                        JSON_QUERY(@Leaf));
                    PRINT N'  برگ درخواست خودرو به عملیات موجود اضافه شد';
                END
            END
        END
    ...
    COMMIT TRANSACTION;
    PRINT N'=== DONE Seed_SrvCarRequest_Menu ===';
END TRY
BEGIN CATCH
