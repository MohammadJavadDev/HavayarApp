...
WHEN NOT MATCHED THEN INSERT
    (HtsId, CustomerId, CustomerPhoneFromHistory, ContactMiladiDate, ContactShamsiDate, CustomerAddressId, ResponsiblePersonelId, DispatchZoneId,
...
VALUES
    (s.HtsId, s.CustomerId, s.CustomerPhoneFromHistory, s.ContactMiladiDate, s.ContactShamsiDate, s.CustomerAddressId, s.ResponsiblePersonelId, s.DispatchZoneId,
