/*
Seed_SrvTicketHotelRequest_Menu.sql
منو: سیستم عمومی/مشترک → پشتیبانی و خدمات → عملیات → درخواست بلیط و هتل
فقط این شاخه؛ بدون همسایه‌ها. UTF-8 BOM. Idempotent. الگوی Seed_SecPersonnel_Menu.
sqlcmd -S <server> -d HavayarApp -C -b -I -f 65001 -i "Data\Scripts\Seed_SrvTicketHotelRequest_Menu.sql"
*/
SET NOCOUNT ON;
SET XACT_ABORT ON;
...
DECLARE @SeedUser NVARCHAR(150) = N'seed-srv-tickethotel-menu';
DECLARE @Path NVARCHAR(200) = N'/panel/srv/tickethotelrequest/list';
...
DECLARE @LeafText NVARCHAR(200) = N'درخواست بلیط و هتل';

DECLARE @Leaf NVARCHAR(MAX) = N'{"text":"درخواست بلیط و هتل","icon":"ki-element-11 ki-outline","iconColor":"#5EEAD4","path":"/panel/srv/tickethotelrequest/list","a_attr":{"href":"/panel/srv/tickethotelrequest/list"},"data":{"iconColor":"#5EEAD4","path":"/panel/srv/tickethotelrequest/list"},"children":[]}';
DECLARE @OpsGroup NVARCHAR(MAX) = N'{"text":"عملیات","icon":"ki-element-11 ki-outline","iconColor":"#5EEAD4","path":"","a_attr":{"href":""},"data":{"iconColor":"#5EEAD4","path":""},"children":[{"text":"درخواست بلیط و هتل","icon":"ki-element-11 ki-outline","iconColor":"#5EEAD4","path":"/panel/srv/tickethotelrequest/list","a_attr":{"href":"/panel/srv/tickethotelrequest/list"},"data":{"iconColor":"#5EEAD4","path":"/panel/srv/tickethotelrequest/list"},"children":[]}]}';
...
BEGIN TRY
    ...
    ELSE IF CHARINDEX(N'"path":"' + @Path + N'"', @Content) > 0
        PRINT N'  برگ درخواست بلیط و هتل از قبل موجود است';
    ELSE
    BEGIN
            ...
            BEGIN
                ...
                BEGIN
                    SET @Content = JSON_MODIFY(@Content,
                        ...
                        JSON_QUERY(@Leaf));
                    PRINT N'  برگ درخواست بلیط و هتل به عملیات موجود اضافه شد';
                END
            END
        END
    ...
    COMMIT TRANSACTION;
    PRINT N'=== DONE Seed_SrvTicketHotelRequest_Menu ===';
END TRY
BEGIN CATCH
