...
namespace Services.QueryBuilderServices
{
	...
	{
		string BuildQuery(QueryDesign design, List<ReportColumn> reportColumns = null);
		string BuildQueryWithSorting(QueryDesign design, List<ReportColumn> columns);
		string BuildQueryWithShaping(QueryDesign design, List<ReportColumn> columns);
	}
	...
	public class QueryBuilderService : IQueryBuilderService
	{
		...
		/// </summary>
		public string BuildQuery(QueryDesign design, List<ReportColumn> reportColumns = null)
		{
			...
			var selectedColumns = GetSelectedColumns(design, tableToAlias, reportColumns);
		...
		/// ساخت Query با Sort
		/// </summary>
		public string BuildQueryWithSorting(QueryDesign design, List<ReportColumn> columns)
		{
		...
		/// </summary>
		public string BuildQueryWithShaping(QueryDesign design, List<ReportColumn> columns)
		{
			if (design == null || design.Tables == null || !design.Tables.Any())
				throw new ArgumentException("حداقل یک جدول باید انتخاب شود");
		...
		private List<string> BuildShapedSelectClauses(List<ReportColumn> columns, Dictionary<string, string> tableToAlias, List<TableInfo> tables)
		{
		...
		/// </summary>
		private List<string> GetSelectedColumns(QueryDesign design, Dictionary<string, string> tableToAlias, List<ReportColumn> reportColumns = null)
		{
