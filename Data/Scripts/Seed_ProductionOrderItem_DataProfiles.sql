...
INSERT INTO #PoiProfiles (Name, Title, FiltersJson) VALUES (N'POI_ViewActive', N'اقلام سفارش ساخت — در فرآیند', N'[{"Id":"id_poi_isdel","TableName":"Sale.ProductionOrderItem","ColumnName":"IsDeleted","DataType":"bit","Operator":"equals","Value":"false","LogicalOperator":""},{"Id":"id_poi_islat","TableName":"Sale.ProductionOrderItem","ColumnName":"IsLatestVersion","DataType":"bit","Operator":"equals","Value":"true","LogicalOperator":"AND"}]');
...
-- NOTE 2026-09-25: کارتابل مهندسی یکپارچه (view-only) جایگزین برق/مکانیک شد.
-- اسکریپت هم‌تراز: Update_ProductionOrderItem_DataProfiles_CartableAlign.sql
INSERT INTO #PoiProfiles (Name, Title, FiltersJson) VALUES (N'POI_Cartable_Engineering', N'منتظر تایید مهندسی', N'[{"Id":"id_poi_isdel","TableName":"Sale.ProductionOrderItem","ColumnName":"IsDeleted","DataType":"bit","Operator":"equals","Value":"false","LogicalOperator":""},{"Id":"id_poi_islat","TableName":"Sale.ProductionOrderItem","ColumnName":"IsLatestVersion","DataType":"bit","Operator":"equals","Value":"true","LogicalOperator":"AND"},{"Id":"id_poi_chk","TableName":"Sale.ProductionOrderItem","ColumnName":"CheckStatus","DataType":"int","Operator":"equals","Value":"2195","LogicalOperator":"AND"}]');
INSERT INTO #PoiProfiles (Name, Title, FiltersJson) VALUES (N'POI_Cartable_ProjectManager', N'منتظر تایید مدیر پروژه', N'[{"Id":"id_poi_isdel","TableName":"Sale.ProductionOrderItem","ColumnName":"IsDeleted","DataType":"bit","Operator":"equals","Value":"false","LogicalOperator":""},{"Id":"id_poi_islat","TableName":"Sale.ProductionOrderItem","ColumnName":"IsLatestVersion","DataType":"bit","Operator":"equals","Value":"true","LogicalOperator":"AND"},{"Id":"id_poi_chk","TableName":"Sale.ProductionOrderItem","ColumnName":"CheckStatus","DataType":"int","Operator":"equals","Value":"2258","LogicalOperator":"AND"}]');
...
INSERT INTO #PoiRoleAccess (ProfileName, RoleName) VALUES (N'POI_Cartable_Industrial', N'Industries');
INSERT INTO #PoiRoleAccess (ProfileName, RoleName) VALUES (N'POI_Cartable_Engineering', N'Sale.ProductionOrderItem.AcceptEngineeringMechanical');
INSERT INTO #PoiRoleAccess (ProfileName, RoleName) VALUES (N'POI_Cartable_Engineering', N'Sale.ProductionOrderItem.AcceptEngineeringElectrical');
...
DECLARE @WhereEng nvarchar(max) = N'
WHERE [t1].[IsDeleted] = 0 AND [t1].[IsLatestVersion] = 1
...
UPDATE q SET q.QueryJson = JSON_MODIFY(q.QueryJson, '$.CustomQuery', @BaseCustomQuery + @WhereEng), q.ModifiedById = 1, q.ModifiedByName = N'seed-poi-dataprofiles', q.ModifiedDateMiladiDateTime = GETDATE() FROM system.SavedQuery q WHERE q.Name = N'POI_Cartable_Engineering';
UPDATE q SET q.IsActive = 0, q.ModifiedById = 1, q.ModifiedByName = N'seed-poi-dataprofiles', q.ModifiedDateMiladiDateTime = GETDATE() FROM system.SavedQuery q WHERE q.Name IN (N'POI_Cartable_Engineering_Mechanical', N'POI_Cartable_Engineering_Electrical');
