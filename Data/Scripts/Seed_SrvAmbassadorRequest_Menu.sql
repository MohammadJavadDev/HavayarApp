/*
Seed_SrvAmbassadorRequest_Menu.sql
منو: سیستم عمومی/مشترک → پشتیبانی و خدمات → عملیات → درخواست پیک
فقط این برگ؛ بدون حذف همسایه‌ها. UTF-8 BOM. Idempotent. الگوی Seed_SrvCarRequest_Menu.
sqlcmd -S <server> -d HavayarApp -C -b -I -f 65001 -i "Data\Scripts\Seed_SrvAmbassadorRequest_Menu.sql"
*/
SET NOCOUNT ON;
SET XACT_ABORT ON;
...
DECLARE @SeedUser NVARCHAR(150) = N'seed-srv-ambassadorrequest-menu';
DECLARE @Path NVARCHAR(200) = N'/panel/srv/ambassadorrequest/list';
...
DECLARE @LeafText NVARCHAR(200) = N'درخواست پیک';

DECLARE @Leaf NVARCHAR(MAX) = N'{"text":"درخواست پیک","icon":"ki-element-11 ki-outline","iconColor":"#5EEAD4","path":"/panel/srv/ambassadorrequest/list","a_attr":{"href":"/panel/srv/ambassadorrequest/list"},"data":{"iconColor":"#5EEAD4","path":"/panel/srv/ambassadorrequest/list"},"children":[]}';
DECLARE @OpsGroup NVARCHAR(MAX) = N'{"text":"عملیات","icon":"ki-element-11 ki-outline","iconColor":"#5EEAD4","path":"","a_attr":{"href":""},"data":{"iconColor":"#5EEAD4","path":""},"children":[{"text":"درخواست پیک","icon":"ki-element-11 ki-outline","iconColor":"#5EEAD4","path":"/panel/srv/ambassadorrequest/list","a_attr":{"href":"/panel/srv/ambassadorrequest/list"},"data":{"iconColor":"#5EEAD4","path":"/panel/srv/ambassadorrequest/list"},"children":[]}]}';
...
BEGIN TRY
    ...
    ELSE IF CHARINDEX(N'"path":"' + @Path + N'"', @Content) > 0
        PRINT N'  برگ درخواست پیک از قبل موجود است';
    ELSE
    BEGIN
            ...
            BEGIN
                ...
                BEGIN
                    SET @Content = JSON_MODIFY(@Content,
                        ...
                        JSON_QUERY(@Leaf));
                    PRINT N'  برگ درخواست پیک به عملیات موجود اضافه شد';
                END
            END
        END
    ...
    COMMIT TRANSACTION;
    PRINT N'=== DONE Seed_SrvAmbassadorRequest_Menu ===';
END TRY
BEGIN CATCH
